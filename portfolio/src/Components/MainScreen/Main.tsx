...
const Main = () => {
  const { showPopup, title, content, browsingHistory, isMinimized, isFullScreen, showWindowPopup, hideWindowPopup, changeTitle, toggleFullScreen, toggleMinimized } = useWindowPopUp();
  return (
